...
def neggers_et_al_2006_stevens_et_al_2002(t,y,SST,D,q_free,th_free,ps,f,U_free,V_free,we, dict_ext, E_frac=1):
    """
...
def neggers_et_al_2006_stevens_et_al_2002_fracUstar(t,y,SST,D,q_free,th_free,ps,f,U_free,V_free,we, dict_ext, frac_Ustar):
    """
    Subscript s denotes surface values, b stands for buoyancy, which is associated with the virtual potential
    temperature (theta_v), th indicates the liquid water potential temperature (theta_l) and q the total specific
    humidity (q_t).
