...
def neggers_et_al_2006(t,y,V,SST,D,q_free,th_free,ps, dict_ext):
    """
...
#    w_star = (g*y[0]*thv_flux_s/th_s)**(1/3) # m/s, Deardorff convective velocity scale. 1st try
    ...
    dict_ext['LHF_CC_ext'].append(q_flux_s_CC*Le*rhos)          # LHF_CC_ext
    dict_ext['qs_ext'].append(q_s)                              # qs_ext
    dict_ext['qsat_ext'].append(q_sat)                          # qsat_ext
    dict_ext['SHF_ext'].append(th_flux_s*cpd*rhos)              # SHF_ext
    dict_ext['LCL_ext'].append(LCL)                             # LCL_ext
